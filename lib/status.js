class StatusPanel {
  constructor(pkg) {
    ...
    this.tooltipDisposable = atom.tooltips.add(this.element, {
      title:
        '<div style="text-align: left; line-height: 1.2em;">Click to toggle panel<br />Middle-click to toggle file/project view<br />Ctrl+middle-click to clear all<br />Right-click to go next<br />Ctrl+right-click to go previous</div>',
      html: true,
    });
  ...
  update() {
    ...
    this.element.classList.toggle(
      ...
      !this.statusMode && ecount + wcount + icount === 0,
    );
  }
