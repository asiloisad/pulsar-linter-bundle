class StatusPanel {
  constructor(pkg) {
    ...
    this.tooltipDisposable = atom.tooltips.add(this.element, {
      title: 'Left: Toggle linter | Middle: Toggle file/project view | Right: Next | Ctrl+Right: Previous | Ctrl+Middle: Clear',
      keyBindingCommand: 'linter-bundle:toggle-linter',
