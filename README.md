...
- **Status Bar Integration**: Shows error, warning, and info counts in the status bar. Left-click opens toggle linter view, middle-click toggles file/project mode, right-click jumps to next, Ctrl+right-click jumps to previous, Ctrl+middle-click clears messages.
